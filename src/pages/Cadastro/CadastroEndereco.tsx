    ...
    <>
      ...
      <Form onSubmit={handleSubmit(aoSubmeter)}>
        <Fieldset>
          ...
          <Input id="campo-cep" placeholder="Insira seu CEP" type="text"  {...register('cep', {required:"O campo é obrigatório"})} $error={!!errors.cep}  onBlur={() => fetchEndereco(cepDigitado)}/>
          {errors.cep && <ErrorMessage>{errors.cep.message}</ErrorMessage>}
        </Fieldset>
        <Fieldset>
          <Label htmlFor="campo-rua">Rua</Label>
          <Input id="campo-rua" placeholder="Rua Agarikov" type="text" $error={!!errors.rua} {...register('rua', {required:"O campo é obrigatório"})}/>
        ...
        <FormContainer>
          <Fieldset>
            ...
            <Input id="campo-numero-rua" placeholder="Ex: 1440" type="text" $error={!!errors.numero} {...register('numero', {required:"O campo é obrigatório"})}/>
            {errors.numero && <ErrorMessage>{errors.numero.message}</ErrorMessage>}
          </Fieldset>
          <Fieldset>
            <Label htmlFor="campo-bairro">Bairro</Label>
            <Input id="campo-bairro" placeholder="Vila Mariana" type="text" $error={!!errors.bairro} {...register('bairro', {required:"O campo é obrigatório"})}/>

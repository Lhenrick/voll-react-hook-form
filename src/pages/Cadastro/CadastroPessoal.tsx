...
const CadastroPessoal = () => {
 ...
 const validaSenha = {
  ...
  tamanhoMinimo: (val: string) =>  val.length >= 6 || "A senha deve conter pelo menos 6 caracteres",
  senhasIguais: (val: string) =>  val === senha || "As senhas não correspodem",
}
      ...
      <Form onSubmit={handleSubmit(aoSubmeter)}>
        <Fieldset>
          ...
          <Input
            ...
            type="text"
            $error={!!errors.nome}
            {...register("nome", {required: "Campo de nome é obrigatório", minLength: {value: 5, message:"O nome deve ter pelo menos cinco caracteres",},})}
          />
        ...
        <Controller
          control={control} name="telefone" rules={{ pattern: {value: /^\(\d{2,3}\) \d{5}-\d{4}$/, message:"O telefone está inserido no formato incorreto",}, required: "Campo telefone é obrigatório",}} render={({field}) => (
            <Fieldset>
        ...
        <Fieldset>
          ...
          <Input
            ...
            type="password"
            {...register('senha', {required:"O campo de senha é obrigatório", minLength: {value: 6, message:"A senha deve conter pelo menos 6 caracteres"}})}
          />
        ...
        <Fieldset>
          ...
          <Input
            ...
            type="password"
            {...register('senhaVerificada', {required:"Repita a senha", validate: validaSenha})}
          />
